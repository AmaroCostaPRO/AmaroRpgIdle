...
*   **Custo e Cooldown**: Possuem os custos de mana mais elevados do jogo — $15\%$ a $27.5\%$ da mana máxima do jogador por uso (Seção 6.A) — e tempos de recarga prolongados (50 a 80 segundos), refletindo seu impacto massivo no combate.
...
1.  **Guerreiro**: *Cólera dos Titãs* (`ultimate_warrior`)
    ...
    *   *Custo de Mana*: $15\%$ a $27.5\%$ da Mana Máxima, conforme o nível da habilidade (Seção 6.A) | *Tempo de Recarga*: $60.000$ ms (60s)
...
2.  **Mago**: *Supernova* (`ultimate_mage`)
    ...
    *   *Custo de Mana*: $15\%$ a $27.5\%$ da Mana Máxima, conforme o nível da habilidade (Seção 6.A) | *Tempo de Recarga*: $70.000$ ms (70s)
...
3.  **Arqueiro**: *Flecha do Juízo Final* (`ultimate_ranger`)
    ...
    *   *Custo de Mana*: $15\%$ a $27.5\%$ da Mana Máxima, conforme o nível da habilidade (Seção 6.A) | *Tempo de Recarga*: $55.000$ ms (55s)
...
4.  **Paladino**: *Julgamento Sagrado* (`ultimate_paladin`)
    ...
    *   *Custo de Mana*: $15\%$ a $27.5\%$ da Mana Máxima, conforme o nível da habilidade (Seção 6.A) | *Tempo de Recarga*: $65.000$ ms (65s)
...
5.  **Clérigo**: *Ascensão Celestial* (`ultimate_cleric`)
    ...
    *   *Custo de Mana*: $15\%$ a $27.5\%$ da Mana Máxima, conforme o nível da habilidade (Seção 6.A) | *Tempo de Recarga*: $80.000$ ms (80s)
...
6.  **Ladrão**: *Lâmina da Aniquilação* (`ultimate_rogue`)
    ...
    *   *Custo de Mana*: $15\%$ a $27.5\%$ da Mana Máxima, conforme o nível da habilidade (Seção 6.A) | *Tempo de Recarga*: $50.000$ ms (50s)
...
*   **Custo de Mana — Percentual da Mana Máxima** *(ajuste pós-lançamento da v9.0.0, `manaFormulas.ts`)*: o custo de mana de cada habilidade não é mais um valor fixo (que ficava irrisório assim que a mana máxima do jogador crescia via atributos de sets/equipamento — era possível chegar a milhares de mana logo no início do jogo, enquanto o custo das habilidades continuava na casa das dezenas). Em vez disso, o custo é calculado como uma **porcentagem da mana máxima atual do jogador** (`calculateMaxMana`), reavaliada a cada uso — assim ele nunca "fica para trás", não importa a fonte do crescimento de mana (nível de personagem, atributos de sets, ascensão):
    *   *Habilidades Comuns*: $\text{Custo} = \text{Mana Máxima} \times (0.0225 + \text{Nível Requerido} \times 0.003) \times (1 + (\text{Nível da Habilidade} - 1) \times 0.12)$. Ex.: uma habilidade de Tier 1 (`requiredLevel: 1`) no nível 1 custa $\approx 2.6\%$ da mana máxima; no nível máximo (15), $\approx 6.8\%$. Uma habilidade de Tier 6 (`requiredLevel: 11`) no nível 15 chega a $\approx 14.9\%$ da mana máxima por uso.
    *   *Habilidades Ultimate*: $\text{Custo} = \text{Mana Máxima} \times \min(0.15 + (\text{Nível da Habilidade} - 1) \times 0.01,\ 0.275)$ — de $15\%$ da mana máxima no nível 1 até um teto de $27.5\%$ em níveis avançados, refletindo o altíssimo poder de uma Ultimate.
    ...
    *   **Ajuste de balanceamento (feedback pós-lançamento)**: a primeira versão percentual acima (Tier 1/Nível 1 $\approx 5.1\%$, Ultimates $30\%$ a $55\%$) se mostrou alta demais na prática — todos os percentuais-base foram **reduzidos pela metade** para os valores atuais listados acima.
