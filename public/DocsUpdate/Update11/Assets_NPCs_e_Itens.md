...
| `story_void_promise.png` | Promessa Quebrada do Vazio | Artefato | **Prompt**: Hyper-detailed fine-line 512-bit micro-pixel art of a shattered obsidian-black promise seal artifact. Floating crystalline obsidian shards with intricate stone engravings, swirling inner galaxy memories, sparkling purple stardust, and glowing violet rune veins INSIDE the cracks. Extreme high resolution micro-pixel texture density, smooth fine dithering, crisp razor-sharp black outlines around all outer edges. CRITICAL: ZERO outer glow, ZERO aura outside the object edges, ZERO background light bleeding. Flat solid uniform pure red background `#FE0201` with NO glow outside, NO shadows, NO background elements. |
