...
### E. Slots de Amuleto (v7.0.0) e Anel (v8.0.0)
...
*   **Contagem de slots equipáveis ao longo das versões**: 5 (base) → 6 com o Colar (v5.0.0) → 7 com o Amuleto (v7.0.0) → 8 com o Anel (v8.0.0). A desmontagem de equipamentos (Seção 5.C) e o desbloqueio de bônus de 2/3/5 peças (Seção 5.B) se aplicam igualmente a ambos os novos slots.
...
### Versão 8.0.0 "O Espelho Faminto" (Atual)
