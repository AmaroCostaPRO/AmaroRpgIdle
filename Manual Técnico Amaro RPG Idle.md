...
*   **2 Receitas**: Poção de Fúria Alquímica (`potion_damage`, +25% de Dano por 3min) e Poção de Regeneração Alquímica (`potion_regen`, regeneração de HP acelerada por 2min) — ativadas instantaneamente ao consumir, reaproveitando o mecanismo de flag+duração já usado pelos Elixires do Mercador Ambulante (v7.0.0).
...
### Versão 9.6.0 "Ajustes de Economia da Cidadela" (Atual)
